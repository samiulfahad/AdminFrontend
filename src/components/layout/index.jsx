  ...
  return (
    <div className="flex min-h-screen bg-slate-50 overflow-x-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0 lg:ml-60 print:ml-0">
        <main className="flex-1 pt-14 lg:pt-0 print:pt-0 bg-slate-50 min-w-0 overflow-x-hidden">
...
//         <main className="flex-1 pt-20 md:pt-14 lg:pt-0 print:pt-0 bg-slate-50">
